...
public class Shader {
    private int program = GL4.GL_NONE;
     ...
     */
    public Shader(GL4 gl, String vertSource, String fragSource) {
        int vShader = compileShader(gl, GL4.GL_VERTEX_SHADER, vertSource);
        int fShader = compileShader(gl, GL4.GL_FRAGMENT_SHADER, fragSource);
     ...
     */
    public int sLoc(GL4 gl, String name) {
     ...
     *                 a Vec2
     */
    public <T> void setUniform(GL4 gl, String name, T value, boolean expanded) {
     ...
     * @param value the value to set
     */
    public <T> void setUniform(GL4 gl, String name, T value) {
     ...
     * @param value the value to set
     */
    public void setUVec2(GL4 gl, String name, Vec2 value) {
     ...
     * @param value the value to set
     */
    public void setUVec3(GL4 gl, String name, Vec2 value) {
     ...
     * @param value the value to set
     */
    public void setUVec3(GL4 gl, String name, Vec3 value) {
     ...
     * @param value the value to set
     */
    public void setUVec4(GL4 gl, String name, Vec3 value) {
     ...
     * @param value the value to set
     */
    public void setUMat2(GL4 gl, String name, Mat2 value) {
    ...
    private static void checkCompileStatus(GL4 gl, int shader) {
